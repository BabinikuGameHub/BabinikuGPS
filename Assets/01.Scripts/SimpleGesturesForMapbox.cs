...
namespace OSMClient
{
    ...
    public class SimpleGesturesForMapbox : MonoBehaviour
    {
        ...
        public static SimpleGesturesForMapbox Instance { get; private set; }
        ...
        private static SimpleGesturesForMapbox instance;
        ...
        private void Start()
        {
            //SimpleGesturesForMapbox.OnPan += Gestures_OnPan;
            SimpleGesturesForMapbox.OnScale += Gestures_OnScale;
            SimpleGesturesForMapbox.OnRotate += Gestures_OnRotate;
        }
        ...
        private void Gestures_OnPan(Vector3 delta)
        {
            ...
            if (Input.GetMouseButton(1))
            {
                ...
                delta = _camera.transform.InverseTransformDirection(delta);
            ...
            _map.UpdateMap(new Mapbox.Utils.Vector2d((float)d.x, (float)d.y));  
        ...
        private void Gestures_OnScale(float d)
        {
            ...
            float currentZoom = _map.Zoom;

            var zoom = currentZoom - 1 + d;
        ...
        {
            var centerPos = LocationHelper.WorldToTilePos(_map.CenterLatitudeLongitude.x, _map.CenterLatitudeLongitude.y, (int)_map.Zoom);
            //var x = centerPos.x + pos.x / _map.UnityTileSize;
            //var y = centerPos.y - pos.z / _map.UnityTileSize;

            var x = centerPos.x - pos.z / 2; 
            var y = centerPos.y + pos.x / 2;

            return LocationHelper.TileToWorldPos(x, y, (int)_map.Zoom);
        }
    }
}